            ...
            child: Column(
              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    rakItem("Peraturan Kejaksaan", Icons.account_balance),
                    rakItem("Pidana", Icons.gavel),
                    rakItem("Perdata", Icons.balance),
                    rakItem("Perundang-Undangan", Icons.article),
                    rakItem("Tata Negara", Icons.account_balance),
                    rakItem("Majalah & Publikasi", Icons.library_books),
                    rakItem("Referensi & Biografi", Icons.book),
                  ],
                ),
              ],
            ),
